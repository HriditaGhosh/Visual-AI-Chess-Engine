...
A fully-featured Chess Application with a custom AI engine built from scratch.

Implements advanced chess search algorithms, AI heuristics, and 12 core DSA concepts.
